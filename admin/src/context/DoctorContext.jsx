...
const DoctorContextProvider = (props) => {
    ...
    const completeAppointment = async (appointmentId) => {
        try {
            ...
            const { data } = await axios.patch(backendUrl + '/api/doctor/complete-appointment', {appointmentId}, {headers: {dToken}})
            if(data.success){
    ...
    const cancelAppointment = async (appointmentId) => {
        try {
            ...
            const { data } = await axios.patch(backendUrl + '/api/doctor/cancel-appointment', {appointmentId}, {headers: {dToken}})
            if(data.success){
                toast.success(data.message)
                getAppointments()
            }else {
