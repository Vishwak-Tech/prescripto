...
const Appointment = () => {
  ...
  const [docSlots, setDocSlots] = useState([])    // Stores all available appointment slots
  const [slotIndex, setSlotIndex] = useState(0)  // Tracks selected day index
  const [slotTime, setSlotTime] = useState('')  // Stores selected appointment time.
  ...
  {/*---- To Caluculate avaliable slots of selected Doctor ---*/}
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 -mt-20 sm:mt-0'>
          ...
          <div>
            <p className='flex items-center gap-1 text-sm font-medium text-gray-900 mt-3'>
              About <img className='w-3' src={assets.info_icon} alt='info_icon' />
            </p>
